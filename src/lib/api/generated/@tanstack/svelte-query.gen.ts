...
export const sermonControllerGetDistinctValuesQueryKey = (options?: Options<SermonControllerGetDistinctValuesData>) => createQueryKey('sermonControllerGetDistinctValues', options);

/**
 * Получить список ранее использованных проповедников и книг (для автодополнения)
 */
export const sermonControllerGetDistinctValuesOptions = (options?: Options<SermonControllerGetDistinctValuesData>) => queryOptions<SermonControllerGetDistinctValuesResponse, DefaultError, SermonControllerGetDistinctValuesResponse, ReturnType<typeof sermonControllerGetDistinctValuesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await sermonControllerGetDistinctValues({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: sermonControllerGetDistinctValuesQueryKey(options)
});
